...
// --- Skill Table ---
DLL_IMPORT int skltab_cnt;
DLL_IMPORT struct skltab *skltab;
DLL_IMPORT int weatab[];
...
DLL_IMPORT struct questlog *game_questlog;
DLL_IMPORT int *game_questcount;
...
// --- Display Settings ---
DLL_IMPORT int __xres;
DLL_IMPORT int __yres;
